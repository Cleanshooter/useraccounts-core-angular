...
AT.prototype.configureRoute = function(route, options) {
  //@TODO needs to use the angularui:angular-ui-router
  //Since the Angular UI Routers is being used to have true antive support we should just make it a dependancies and include it.
  //IN the end there will be no need for this error message...
  console.warn('You now need the routing package like useraccounts:iron-routing or useraccounts:flow-routing to be able to configure routes!');
};
